...
proc createCallWrapper[T: Calculator](ty: typedesc[T], capServer: CapServer): Calculator_CallWrapper =
  return Calculator_CallWrapper(cap: capServer)

miscCapMethods(Calculator)
...
proc createCallWrapper[T: Calculator_Value](ty: typedesc[T], capServer: CapServer): Calculator_Value_CallWrapper =
  return Calculator_Value_CallWrapper(cap: capServer)

miscCapMethods(Calculator_Value)
...
proc createCallWrapper[T: Calculator_Function](ty: typedesc[T], capServer: CapServer): Calculator_Function_CallWrapper =
  return Calculator_Function_CallWrapper(cap: capServer)

miscCapMethods(Calculator_Function)
